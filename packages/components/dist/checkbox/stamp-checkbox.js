 ...
 */
let StampCheckbox = class StampCheckbox extends StampElement {
    constructor() {
        super(...arguments);
        this.checked = false;
...
], StampCheckbox.prototype, "checked", void 0);
__decorate([
    property({ type: Boolean })
], StampCheckbox.prototype, "indeterminate", void 0);
__decorate([
    property()
], StampCheckbox.prototype, "label", void 0);
__decorate([
    property()
], StampCheckbox.prototype, "name", void 0);
__decorate([
    property()
], StampCheckbox.prototype, "value", void 0);
__decorate([
    query('input')
], StampCheckbox.prototype, "_input", void 0);
StampCheckbox = __decorate([
    customElement('stamp-checkbox')
], StampCheckbox);
export { StampCheckbox };
//# sourceMappingURL=stamp-checkbox.js.map