...
let StampInput = class StampInput extends StampElement {
    constructor() {
        super(...arguments);
        this.label = '';
        this.placeholder = '';
        ...
        this.required = false;
        this.readonly = false;
        this._uid = `stamp-input-${Math.random().toString(36).slice(2, 9)}`;
    }
    _handleInput(e) {
...
__decorate([
    property()
], StampInput.prototype, "label", void 0);
__decorate([
    property()
], StampInput.prototype, "placeholder", void 0);
__decorate([
    property()
], StampInput.prototype, "type", void 0);
__decorate([
    property()
], StampInput.prototype, "value", void 0);
__decorate([
    property()
], StampInput.prototype, "name", void 0);
__decorate([
    property()
], StampInput.prototype, "helper", void 0);
__decorate([
    property({ reflect: true })
], StampInput.prototype, "error", void 0);
__decorate([
    property({ type: Boolean })
], StampInput.prototype, "required", void 0);
__decorate([
    property({ type: Boolean })
], StampInput.prototype, "readonly", void 0);
__decorate([
    state()
], StampInput.prototype, "_uid", void 0);
StampInput = __decorate([
    customElement('stamp-input')
], StampInput);
export { StampInput };
//# sourceMappingURL=stamp-input.js.map